...
<form action="/libros/update/{{$libro->id}}" method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="nombre" name="titulo" value="{{$libro->titulo}}" required>
    </div>
    <div class="mb-3">
        <label for="descripcion" class="form-label">Autor</label>
        <input type="text" class="form-control" id="descripcion" name="autor" value="{{$libro->autor}}" required>
    </div>
    <div class="mb-3">
        <label for="anio_publicacion" class="form-label">Año de Publicacion</label>
        <input type="date" class="form-control" id="anio_publicacion" name="anio_publicacion" value="{{$libro->anio_publicacion}}" required>
    </div>
    <div class="mb-3">
